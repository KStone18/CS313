      ...
      <ul>
        <li> 
          ...
          <button id="btn1" class="btn btn-primary btn-xs buttonCSS" 
                  name="button1" onclick="addToCart('R/C Truck', 200.00)">Add To Cart</button>
        </li>
        <li> 
          ...
          <button id="btn2" class="btn btn-primary btn-xs buttonCSS" 
                  name="button2" onclick="addToCart('White R/C Truck', 200.00)">Add To Cart</button>
        ...
        <li> 
          ...
          <button id="btn3" class="btn btn-primary btn-xs buttonCSS" 
                  name="button3"  onclick="addToCart('R/C Boat', 150.00)">Add To Cart</button>
        </li>
        <li> 
          ...
          <button id="btn4" class="btn btn-primary btn-xs buttonCSS" 
                  name="button4" onclick="addToCart('R/C Plane', 400.00)">Add To Cart</button>
        ...
        <li> 
          ...
          <button id="btn5" class="btn btn-primary btn-xs buttonCSS" 
                  name="button5" onclick="addToCart('R/C Excavator', 150.00)">Add To Cart</button>
        ...
        <li> 
          ...
          <button id="btn6" class="btn btn-primary btn-xs buttonCSS" 
                  name="button6" onclick="addToCart('R/C Drone', 900.00)">Add To Cart</button>
        ...
        <li> 
          ...
          <button id="btn7" class="btn btn-primary btn-xs buttonCSS" 
                  name="button7" onclick="addToCart('R/C Tank', 160.00)">Add To Cart</button>
        ...
        <li> 
          ...
          <button id="btn8" class="btn btn-primary btn-xs buttonCSS" 
                  name="button8" onclick="addToCart('R/C Submarine', 400.00)">Add To Cart</>
