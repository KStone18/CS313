    ...
    <div class="container">
      <ul>
        <li> 
          ...
          <img src="car1.png" alt=""  height="202" class="image" />
          <button type="button" class="btn btn-primary btn-xs ">Add to Cart</button>
        </li>
        <li> 
          <div class="title">Item 2</div> 
          <img src="car2.png" alt="" height="201" class="image" /> 
          <button type="button" class="btn btn-primary btn-xs">Add to Cart</button>
        </li>
        <li> 
          <div class="title">Item 3</div> 
          <img src="Boat.png" alt="" height="205" class="image" />
          <button type="button" class="btn btn-primary btn-xs">Add to Cart</button>
        </li>
        <li> 
          <div class="title">Item 4</div> 
          <img src="Jet.png" alt="" height="210" class="image" />
          <button type="button" class="btn btn-primary btn-xs">Add to Cart</button>
        </li>
        <li> 
          <div class="title">Item 5</div> 
          <img src="excavator.png" alt="" height="208" class="image" />
          <button type="button" class="btn btn-primary btn-xs">Add to Cart</button>
        </li>
        <li> 
          <div class="title">Item 6</div> 
          <img src="Quadcopter.png" alt="" height="209" class="image" />
          <button type="button" class="btn btn-primary btn-xs">Add to Cart</button>
        </li>
        <li> 
          <div class="title">Item 7</div> 
          <img src="tank.png" alt="" height="202" class="image" />
          <button type="button" class="btn btn-primary btn-xs">Add to Cart</button>
        </li>
        <li> 
