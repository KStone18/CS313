    ...
    <div class="container">
      <ul>
        ...
        <li> 
          ...
          <img src="Jet.png" alt="" height="260" class="image" />
          <button type="button" class="btn btn-primary btn-xs">Add to Cart</button>
        </li>
        <li> 
          <div class="title">Item 5</div> 
          <img src="excavator.png" alt="" height="260" class="image" />
          <button type="button" class="btn btn-primary btn-xs">Add to Cart</button>
        </li>
        <li> 
          <div class="title">Item 6</div> 
          <img src="Quadcopter.png" alt="" height="260" class="image" />
          <button type="button" class="btn btn-primary btn-xs">Add to Cart</button>
        </li>
        <li> 
          <div class="title">Item 7</div> 
          <img src="tank.png" alt="" height="260" class="image" />
          <button type="button" class="btn btn-primary btn-xs">Add to Cart</button>
        </li>
        <li> 
          <div class="title">Item 8</div> 
          <img src="sub.png" alt="" height="260" class="image" />
          <button type="button" class="btn btn-primary btn-xs">Add to Cart</button>
        </li>
      </ul>
    </div>
